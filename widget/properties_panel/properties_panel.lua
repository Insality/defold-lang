...
local property_checkbox = require("widget.properties_panel.properties.property_checkbox")
local property_slider = require("widget.properties_panel.properties.property_slider")
local property_button = require("widget.properties_panel.properties.property_button")
local property_input = require("widget.properties_panel.properties.property_input")
local property_text = require("widget.properties_panel.properties.property_text")
local property_left_right_selector = require("widget.properties_panel.properties.property_left_right_selector")
local property_vector3 = require("widget.properties_panel.properties.property_vector3")
